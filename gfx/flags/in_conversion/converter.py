...
def main_for_people_who_code():
    large_done = False
    flag_dic = 'E:\Documents\Paradox Interactive\Hearts of Iron IV\mod\bunker-dev\gfx\flags\in_conversion\tga'
    large_dic = 'E:\Documents\Paradox Interactive\Hearts of Iron IV\mod\bunker-dev\gfx\flags\in_conversion\tga\standard'
    medium_dic = 'E:\Documents\Paradox Interactive\Hearts of Iron IV\mod\bunker-dev\gfx\flags\in_conversion\tga\medium'
    small_dic = 'E:\Documents\Paradox Interactive\Hearts of Iron IV\mod\bunker-dev\gfx\flags\in_conversion\tga\small'
    if large_done:
        make_resized_images_large_done(flag_dic, medium_dic, small_dic, in_fmt, out_fmt)
    else:
        make_resized_images(flag_dic, large_dic, medium_dic, small_dic, in_fmt, out_fmt)
